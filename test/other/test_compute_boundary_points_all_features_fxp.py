...
def test_compute_boundary_points_all_features_fxp():
    ...
    ####### TEST
    boundary_points_fxp = discretizer_fxp.compute_boundary_points_all_features_fxp(input_values_fxp)
    boundary_points = discretizer.compute_boundary_points_all_features(input_values)
    ...
    assert error < TEST_EPSILON

if __name__ == '__main__':
    test_feature_boundary_points_fxp()